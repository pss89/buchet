...
<script>
import buchetIcon from '@/assets/img/icon/buchet_icon.png'
...
export default {
  ...
  methods: {
    ...
    pageMove: function (moveType) {
      ...
      switch (moveType) {
        case 'github':
          window.open('https://github.com/pss89')
          break
        case 'blog':
          window.open('https://buchet.tistory.com/')
          break
        case 'insta':
          window.open('https://www.instagram.com/buchet89/')
          break
        default:
          alert('허용하지 않는 유형입니다.')
          return false
