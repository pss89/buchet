  ...
  <div id="intro" class="container mx-auto p-4 flex flex-col md:flex-row items-center mt-5">
    ...
    <div class="w-full md:w-1/3">
      <img
        v-lazy="profileImage"
        alt="Profile"
        class="rounded-full w-32 h-32 mx-auto md:mx-0 md:w-48 md:h-48"
      />
    </div>
...
<script>
import ssparkCaricature from '@/assets/img/main/pss_caricature.png'
